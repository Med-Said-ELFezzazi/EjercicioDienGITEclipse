...
public class VersionInfo {
     ...
     * Build Timestamp.
     */
    private static final String BUILD_TIMESTAMP = "2023-07-18-194812";

    /**
     * Hudson Job Name.
     */
    private static final String HUDSON_JOB_NAME = "OpenJFX-build-linux-aarch64";

    /**
     * Hudson Build Number.
     */
    private static final String HUDSON_BUILD_NUMBER = "149";

    /**
     * Promoted build number used as part of the runtime version string.
     */
    private static final String PROMOTED_BUILD_NUMBER = "3";

    /**
     * Raw Version number string. (without milestone tag)
     */
    private static final String RELEASE_VERSION = "20.0.2";
